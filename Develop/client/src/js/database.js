...
export const putDb = async (content) =>{
  //crate db connection, creates a transaction, and sends request to store content and log it to the console!
...
export const getDb = async () => {
  //reading from database, if successful it will console log the data, otherwise it will log data not found!
